...
export default function NumberKeyboard({
	...
	// Deconstruct the numbers array from the keyboard JSON
	const { numbers } = MOBILE_KEYBOARD;
	...
	return (
		<>
			...
			{numbers.map((row: string[], index: number) => (
				<div className='row'>
					{/* If on the third row, add secondary keyboard toggler at the beginning of the row */}
					{index === 2 ? (
