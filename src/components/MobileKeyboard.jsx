...
export default function MobileKeyboard({ handleAddText, handleBackspace, handleCaseChange }) {
    ...
    const shiftElement = 
    <>
        <button className='key shift-key' onClick={() => handleCaseChange()}><i class="fa-solid fa-up-long"></i></button>
    </>;
    ...
    <>
        <button className='key backspace-key' onClick={() => handleBackspace()}><i className="fa-solid fa-delete-left"></i></button>
    </>;
    function pageSwitcherElement(page) {
        return (
            <>
                <button className='key pageswitcher-key' onClick={() => handlePageSwitch(page)}><div className="pageswitcher-icon">{page}</div></button>
            </>
        )
    }
    function subPageSwitcherElement(page) {
        return (
            <>
                <button className='key special-key' onClick={() => handlePageSwitch(page)}><div className="pageswitcher-icon">{page}</div></button>
            </>
        )
    }
